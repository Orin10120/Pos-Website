                            ...
                            <div className="card border-0">
                                <div className="card-header bg-light d-flex justify-content-between align-items-center">
                                    <h5 className="card-title fw-bold mb-0">
                                        <i className="bi bi-shield-fill-plus me-2"></i>Tambah Role Baru
                                    </h5>
                                    <Link
                                        href="/admin/roles"
                                    ...
                                    <form onSubmit={handleSubmit}>
                                            ...
                                            <div className="col-md-12">
                                                <div className="form-floating mb-3">
                                                    <input
                                                        ...
                                                        autoComplete="off"
                                                    />
                                                    <label htmlFor="roleName">Nama Role <span className="text-danger">*</span></label>
                                                    {errors.name && (
                                        ...
                                        <div className="mb-3">
                                            <div className="d-flex justify-content-between align-items-center mb-3">
                                                <label className="fw-semibold mb-0">Hak Akses <span className="text-danger">*</span></label>
